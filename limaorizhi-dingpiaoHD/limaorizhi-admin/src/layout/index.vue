      ...
      <div class="sidebar-bottom">
        ...
        <transition name="flyout">
          <div v-if="showSettingsPanel" class="settings-flyout">
            ...
            <div v-if="authStore.isSuperAdmin()" class="flyout-item" @click="goSetting('/system/insurance-providers')">
              <span class="flyout-icon" v-html="icons.insurance"></span>
              <span>保险配置</span>
            </div>
...
// 保险配置图标（盾牌保单）
const insuranceIcon = '<svg viewBox="0 0 1024 1024" xmlns="http://www.w3.org/2000/svg" width="16" height="16"><path d="M502.528 988.416c-83.968 0-186.88-96.768-240.896-154.624C198.144 765.696 126.72 670.464 120.32 622.08c-0.256-1.792-0.768-4.352-1.536-7.168-1.28-5.888-3.072-13.568-3.072-22.272V199.68c0-8.192 3.328-16.128 9.216-22.016s13.824-8.96 22.272-8.704c3.328 0 208.384 2.304 335.36-124.928 11.776-11.776 30.976-12.032 43.264-0.256C658.688 173.056 861.184 168.96 863.232 168.96c8.192-0.256 16.384 2.816 22.272 8.704 5.888 5.888 9.216 13.824 9.216 22.016V611.072c-3.584 47.872-77.056 146.432-143.616 217.6-55.808 59.648-162.56 159.744-248.576 159.744zM177.408 229.632v363.264c0 1.792 0.768 5.12 1.536 8.448 0.768 3.84 1.792 8.192 2.56 13.056 2.816 21.248 51.712 99.328 125.184 177.92 77.824 83.2 152.832 135.168 195.84 135.168 44.544 0 122.624-53.76 203.52-140.288 81.152-86.528 124.672-160.768 127.232-179.456V229.632c-64-3.584-212.224-23.296-328.704-122.112C390.912 206.08 241.92 225.792 177.408 229.632zM146.688 199.68z" fill="#1a1a1a"></path><path d="M617.728 535.808h-229.12c-16.896 0-30.72-13.824-30.72-30.72s13.824-30.72 30.72-30.72h229.12c16.896 0 30.72 13.824 30.72 30.72s-13.824 30.72-30.72 30.72zM616.448 642.048h-229.12c-16.896 0-30.72-13.824-30.72-30.72s13.824-30.72 30.72-30.72h229.12c16.896 0 30.72 13.824 30.72 30.72s-13.824 30.72-30.72 30.72z" fill="#1a1a1a"></path><path d="M501.504 524.544c-8.96 0-17.408-3.84-23.296-10.752l-119.04-138.496c-11.008-12.8-9.728-32.256 3.328-43.264 12.8-11.008 32.256-9.728 43.264 3.328l94.976 110.592 90.112-110.848c10.752-13.056 29.952-15.104 43.264-4.352 13.056 10.752 15.104 29.952 4.352 43.264l-113.408 139.264c-5.632 7.168-14.336 11.264-23.296 11.264h-0.256z" fill="#1a1a1a"></path><path d="M501.504 722.688c-16.896 0-30.72-13.824-30.72-30.72v-206.336c0-16.896 13.824-30.72 30.72-30.72s30.72 13.824 30.72 30.72v206.336c0 17.152-13.824 30.72-30.72 30.72z" fill="#1a1a1a"></path></svg>'
