...
<template>
  <div class="page-container">
    ...
    <el-dialog v-model="dialogVisible" :title="editing.id ? '编辑车辆' : '新增车辆'" width="450px">
...
const editing = reactive({ id: 0, plate_no: '', vehicle_type: '', seat_count: 0, status: 1 })
...
const handleAdd = () => { Object.assign(editing, { id: 0, plate_no: '', vehicle_type: '', seat_count: 0, status: 1 }); dialogVisible.value = true }
